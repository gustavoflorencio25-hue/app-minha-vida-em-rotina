...
export default function Formulario({ onSave, onCancel, registroEmEdicao }) {
  ...
  useEffect(() => {
    if (registroEmEdicao) {
      ...
      setdiadenutrisionista(String(registroEmEdicao.nutricionista)); // Corrigido de 'nutricao' para 'nutricionista'
    } else {
      setdiadedieta('');
      setdiadeacademia('');
  ...
  return (
    <View style={styles.card}>
      ...
      <TextInput style={styles.input} placeholder="Dia de nutricionista" keyboardType="numeric" value={diadenutrisionista} onChangeText={setdiadenutrisionista} /> 
      {/* Corrigido o 'value' e 'onChangeText' do terceiro input */}
